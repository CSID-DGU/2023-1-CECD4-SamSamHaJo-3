    ...
    for (let i = 0; i < fileArr.length; i++) {
      ...
      reader.onload = (e) => {
        ...
        if (type == 1) {
          ...
          setStudentId(jsonData[5][8].split(": ")[1]);
          setCourse("심화과정");
          setEnglishLevelTest(jsonData[3][20].split(":")[1]);
      ...
      <div className="container mx-auto h-screen">
        <div className="text-blue-500 flex flex-col items-start space-y-4 ml-4">
          ...
          <div className="flex space-x-4">
            <label className="flex items-center">
              ...
              />
              <button
                className="bg-blue-500 text-white py-2 px-2 rounded-lg font-bold hover:bg-blue-600 transition duration-200"
          ...
          <div className="flex items-center space-x-1 text-black">
            <label className="flex items-center font-bold">
              ...
              <select
                ...
                className="bg-white border border-gray-400 px-2 py-2 rounded-lg"
              ...
              <table className="border">
                <thead>
                  <tr>
                    ...
                    <th className="border px-2 py-2">학기</th>
                    <th className="border px-2 py-2">이수구분</th>
                    <th className="border px-2 py-2 w-[100px]">
                      이수구분
                      <br />
                      영역
                    </th>
                    ...
                    <th className="border px-2 py-2">교과목명</th>
                    <th className="border px-2 py-2 w-[80px]">
                      담당
                      <br />
                      교원
                    </th>
                    <th className="border px-2 py-2">학점</th>
                    <th className="border px-2 py-2">등급</th>
                    <th className="border px-2 py-2">공학인증</th>
                    <th className="border px-2 py-2">삭제구분</th>
                    <th className="border px-2 py-2">공학요소</th>
                    <th className="border px-2 py-2 w-[100px]">
                      공학세부
                      <br />
                      요소
                ...
                <tbody>
                  {data.map(
                    (item, index) =>
                      item.학점 !== "" && (
                        <tr key={index} className="h-[65px] text-[14px]">
        ...
        {graduated ? (
          <div className="mt-4 text-center">
            ...
            <button
              className="bg-blue-500 text-white py-2 px-2 rounded-lg font-bold hover:bg-blue-600 transition duration-200 mt-4"
